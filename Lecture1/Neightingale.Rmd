...
Analysis of these data, support Nightingale's conclusion that introducing Sanitation Officers did, in fact, reduce preventable deaths and from disease and other causes. At the 95% confidence level we can reject the null hypothesis that Sanitation Officers had no effect on the rate of preventable deaths. However, we cannot reject the hypothesis that combat deaths from wounds decreased following the introduction of Sanitation Officers. 
...
![Original Nightingale Grapic](C:\Users\StevePC2\Dropbox\UW\DataSci350\Summer 2016\Lecture 1\Nightingale-graphic.jpg)

This graphic is remarkable both for the amount of information displayed and considering the state of analytics in the 1850's. In our era we have many more tools at our disposal that Florance Nightingale could not have imagined. Let's have a look at what we can do with these tools.
...
This analysis supports Nightingale's original conjecture that introduction of Sanitation Officers significantly reduced the rate of death amoung soldier from preventable causes. Using several methods it is shown that  the introduction Sanitation Officers significantly reduced the rate of preventable deaths, primarily from disease. The rate of death from other causes was also significantly reduced after March 1855. Intoducton of Sanitation Officers had no effect on combat death rates. 
